 ...
 */
fun quadraticRootProduct(a: Double, b: Double, c: Double): Double = c / a
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = toRadians((sec / 60.0 + min) / 60.0 + grad)
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int =
        seconds(hoursArrive - hoursDepart, minutesArrive - minutesDepart, 0) / 60
